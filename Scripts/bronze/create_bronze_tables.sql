/*=====================================================================
  ...
  Purpose:
  - Create raw-stage tables in the 'bronze' schema of the DataWarhouse database.
  - Tables sourced from CRM and ERP systems.
  - Drops existing tables if they exist to allow clean re-creation.
  - Serves as the first step in the ETL pipeline (Bronze → Silver → Gold).
